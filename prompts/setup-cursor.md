# CodeManifest Setup — Cursor

Set up the Operations Config Pattern in this project for Cursor. Download scripts, create a `.cursor/rules/` rule file, and run an integration test.
...
## Step 2: Create Cursor Rule

```bash
mkdir -p .cursor/rules
```

Create `.cursor/rules/codemanifest.mdc` with this exact content:

~~~
---
description: Operations Config Pattern — AI produces ops.json instead of writing code directly
globs:
alwaysApply: true
---
...
echo "=== Cursor Rule ==="
ls .cursor/rules/codemanifest.mdc
